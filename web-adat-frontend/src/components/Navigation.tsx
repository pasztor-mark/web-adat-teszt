      ...
      <div className=" mx-auto px-4 sm:px-6 lg:px-8">
        <div className="hidden justify-between h-16 sm:ml-6 sm:flex sm:space-x-8">
          <NavLink
            to="/"
            className={({ isActive }) =>
              `text-white font-bold text-2xl flex gap-2 items-center ${
                isActive ? "underline" : "decoration-indigo-600"
              }`
            }
          >
            <FaClipboardCheck />
          ...
          <NavLink
            to="/manual"
            className={({ isActive }) =>
              `text-white text-xl flex gap-2 items-center ${
                isActive ? "underline" : "decoration-indigo-600"
              }`
            }
          >
          ...
          <SheetContent side="right" className="sm:hidden h-full">
            <div className="pt-2 py-20 h-full flex flex-col justify-evenly gap-5 scale-110 space-y-1">
              <NavLink
                to="/"
                className={({ isActive }) =>
                  `text-white text-2xl font-bold flex gap-2 items-center ${
                    isActive ? "bg-neutral-800 p-3 rounded-3xl" : ""
                  }`
                }
              >
                <FaClipboardCheck />
